...
const grootSongs = grootPlaylist.map(preference => preference.title + " " + "By " + " " + preference.artist)
const starlordSongs = startlordPlaylist.map(preference => preference.title + " " + "By " + " " + preference.artist)
const draxSongs = draxPlaylist.map(preference => preference.title + " " + "By " + " " + preference.artist)
const gamoraSongs = gamoraPlaylist.map(preference => preference.title + " " + "By " + " " + preference.artist)
const rocketSongs = rocketPlaylist.map(preference => preference.title + " " + "By " + " " + preference.artist)
